...
int main(void) {
    ...
    /* when the stop message arrives this method handles them and stops the processing*/
    ...
    /* delete the server instance after processing*/
